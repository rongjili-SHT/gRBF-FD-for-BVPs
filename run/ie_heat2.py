...
import time
import numpy as np
from problems.heat_helical_pipe import heat_helical_pipe
from problems.heat_semi_rbc import heat_semi_rbc

def run_experiment(args):
    i, N, j, seed, l_index, l, K, l_grad, K_grad = args
    try:
        ie = heat_helical_pipe(N=N, l=l, K=K, l_grad=l_grad, K_grad=K_grad, seed=seed)
...
if __name__ == '__main__':
    ...
    np.save('./data/heat_helical_pipe.npy', results)